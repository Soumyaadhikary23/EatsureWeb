...
public class D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_Netbanking {

	public static final Logger log = LogManager.getLogger(D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_Netbanking.class.getName());
	...
	public void selectionOfPaymentMode() {
		...
		payments.clickNetbankingButton(driver);
		payments.verifyNBCard(driver);
	...
	public void proceedToPay() {
		...
		log.info("Used Netbanking mode to place an order");
	}
