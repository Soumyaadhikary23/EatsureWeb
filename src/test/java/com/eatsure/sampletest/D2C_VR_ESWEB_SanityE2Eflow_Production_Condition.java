...
public class D2C_VR_ESWEB_SanityE2Eflow_Production_Condition {

	public WebDriver driver;
	Driver driver1;
	SoftAssert as;
	public static final Logger log = LogManager.getLogger(D2C_VR_ESWEB_SanityE2Eflow_Production_Condition.class.getName());
