...
public class D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_Wallet {

	public static final Logger log = LogManager.getLogger(D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_Wallet.class.getName());
	...
	public void selectionOfPaymentMode() {
		...
		payments.clickWalletButton(driver);
		payments.verifyWalletCard(driver);
		payments.verifyAmount();
		log.info("Selected Wallet pay mode");
	}
	...
	public void proceedToPay() {
		...
		log.info("Used Wallet mode to place an order");
	}
