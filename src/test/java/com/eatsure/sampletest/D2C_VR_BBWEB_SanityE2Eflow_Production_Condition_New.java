...
public class D2C_VR_BBWEB_SanityE2Eflow_Production_Condition_New extends BasePage {

	public WebDriver driver;
	Driver driver1;
	SoftAssert as;
	public static final Logger log = LogManager.getLogger(D2C_VR_BBWEB_SanityE2Eflow_Production_Condition_New.class.getName());
...
//		List<WebElement> elements=driver.findElements(By.xpath("//button[normalize-space()='See all']"));
