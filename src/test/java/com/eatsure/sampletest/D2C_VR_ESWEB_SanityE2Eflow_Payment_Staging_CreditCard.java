...
public class D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_CreditCard {

	public static final Logger log = LogManager.getLogger(D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_CreditCard.class.getName());
	...
	public void selectionOfPaymentMode() {
		...
		payments.clickCCButton(driver);
		payments.verifyCCCard(driver);
		payments.AddNewCCCard(driver);
		payments.verifyAmount();
		log.info("Selected Credit card pay mode");
	}
	...
	public void proceedToPay() {
		...
		log.info("Used Credit card mode to place an order");
	}
