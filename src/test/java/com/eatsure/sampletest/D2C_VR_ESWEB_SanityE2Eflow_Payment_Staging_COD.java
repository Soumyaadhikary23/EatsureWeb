...
public class D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_COD {
    public static final Logger log = LogManager.getLogger(D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_COD.class.getName());
