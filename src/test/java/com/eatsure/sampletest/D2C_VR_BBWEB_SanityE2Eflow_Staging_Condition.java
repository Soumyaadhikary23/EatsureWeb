...
public class D2C_VR_BBWEB_SanityE2Eflow_Staging_Condition {

	public WebDriver driver;
	Driver driver1;
	SoftAssert as;
	public static final Logger log = LogManager.getLogger(D2C_VR_BBWEB_SanityE2Eflow_Staging_Condition.class.getName());
	...
	public void initialize(@Optional("chrome") String browser) throws IOException {
		...
		driver.get(Driver.prop.getProperty("urlStagingBB"));
	}
...
//    	landing.enterLocation(Driver.prop.getProperty("location"));
		...
		ValidateTitle.verifyTitle(driver, "Order Royal Biryani Online from Behrouz Biryani");
