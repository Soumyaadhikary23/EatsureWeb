...
public class D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_DebitCard {

	public static final Logger log = LogManager.getLogger(D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_DebitCard.class.getName());
	...
	public void selectionOfPaymentMode() {
		...
		payments.clickDCButton(driver);
		payments.verifyDCCard(driver);
		payments.AddNewDCCard(driver);
		log.info("Selected Debit card pay mode");
	}
	...
	public void proceedToPay() {
		...
		payments.clickSuccess(driver);
		log.info("Used Debit card mode to place an order");
	}
