...
public class D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_Sodexo {

	public static final Logger log = LogManager.getLogger(D2C_VR_ESWEB_SanityE2Eflow_Payment_Staging_Sodexo.class.getName());
	...
	public void selectionOfPaymentMode() throws InterruptedException {
		...
		payments.clickSodexoButton(driver);
		payments.verifySodexoCard(driver);
		payments.verifyAmount();
		log.info("Selected Sodexo pay mode");
	}
	...
	public void proceedToPay() {
		...
		payments.SodexoEnterPIN(driver);
		log.info("Used sodexo mode to place an order");
	}
